...
| [fishing](./fishing/) | A Stardew-inspired ASCII fishing game for your terminal - take a break without leaving the CLI | **Command:** `/fishing` - Launches the game in your terminal (needs a real TTY, so it prints a command to run) |
